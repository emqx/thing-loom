#!/usr/bin/env python3
"""Create matching ESP32 BH1750 firmware and a local-or-remote dashboard."""
...
def main() -> None:
    ...
    if not 0 <= args.sda <= 30 or not 0 <= args.scl <= 30 or args.sda == args.scl:
        parser.error("SDA and SCL must be different GPIO numbers between 0 and 30")

    suffix = secrets.token_hex(4)
    topic = "bh1750/readings"
    worker = args.worker_name or f"esp32-bh1750-{suffix}"
